...
namespace KURSACH
{
    public class CollegeContext: DbContext
    {
		...
		public void SeedDb()
		{
			...
			FileInfo newFile = new FileInfo(@"C:\KURSACH\st.xlsx");
			...
			{
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp1, Student = student, Subject = sub1, Teacher = teacher1 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp2, Student = student, Subject = sub1, Teacher = teacher1 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp3, Student = student, Subject = sub1, Teacher = teacher1 });
			}

			foreach(var student in Students)
			{
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp1, Student = student, Subject = sub2, Teacher = teacher2 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp2, Student = student, Subject = sub2, Teacher = teacher2 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp3, Student = student, Subject = sub2, Teacher = teacher2 });
			}

			foreach(var student in Students)
			{
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp1, Student = student, Subject = sub3, Teacher = teacher2 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp2, Student = student, Subject = sub3, Teacher = teacher2 });
				student.Marks.Add(new Mark { Value = new Random().Next(0, 10), ControlPoint = cp3, Student = student, Subject = sub3, Teacher = teacher2 });
			}
			this.SaveChanges();
		}
    }
